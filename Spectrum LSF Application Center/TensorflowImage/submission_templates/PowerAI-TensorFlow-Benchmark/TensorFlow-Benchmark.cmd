...
COMMANDTORUN="python /home/$USER/$PYTHON_VER/envs/$PAIV_ENV/tf_cnn_benchmarks/tf_cnn_benchmarks.py --batch_size=$TF_BATCH_SIZE --num_batches=$TF_NUM_BATCHES --num_warmup_batches=$TF_NUM_WARMUP_BATCHES --data_format=$TF_DATA_FORMAT --optimizer=$TF_OPTIMIZER --variable_update=$TF_VARIABLE_UPDATE --num_gpus=$TF_NUM_GPUS --model=$TF_MODEL --use_fp16=$TF_USE_FP16"
